  ...
  return (
    <div className="flex flex-col space-y-4">
      ...
      <div className="flex space-x-3 overflow-x-auto pb-2 no-scrollbar">
        {[1,2,3,4].map((i) => (
          <div key={i} className="flex-shrink-0 w-14 h-14 rounded-full border-2 border-brand-purple p-0.5">
      ...
      <div className="w-full aspect-square rounded-2xl bg-gradient-to-br from-brand-purple via-brand-pink to-brand-cyan p-4 flex flex-col justify-end shadow-lg group">
         <div className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-md mb-2 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
         </div>
         <h3 className="text-2xl font-bold text-white">React Native</h3>
         <p className="text-white/80 text-sm">Universal Apps</p>
      </div>

       {/* List Items */}
      <div className="space-y-3">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex items-center space-x-3 p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-colors cursor-pointer">
      ...
      <div className="absolute bottom-6 right-6 w-12 h-12 bg-brand-cyan rounded-full shadow-lg shadow-brand-cyan/50 flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-white"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
      </div>
    </div>
  )
}
